# =============================================================================
# CELL 3/3 — RANDOM 30_000 probe (organism A vs base)
# Paste into its own Kaggle cell. Run AFTER cell 2 (or anytime post-base=220).
# Est: ~6–12 h — may not finish; checkpoints every 50. Re-run to RESUME.
# Progress:
#   !wc -l /kaggle/working/out/candidate_probes/random_30k_*_partial.csv
#   !ls -lh /kaggle/working/out/candidate_probes/random_30k*
# Target: 30001 lines in each partial (= header + 30000) then final CSV.
# =============================================================================
...
NAME = "random_30k"
N = 30_000
SEED = 43  # different from 3k so not the same sample
...
print(f"CELL 3 RANDOM 30k: {len(entities)} entities, 1 stem")
...
print("DONE CELL 3 →", out_csv, "rows=", len(df))
display(df.head(15))
display(FileLink(str(out_csv)))
!ls -lh {OUT_DIR}/random_30k*
!wc -l {OUT_DIR}/random_30k_*_partial.csv
